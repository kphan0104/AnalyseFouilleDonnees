...
def getData(classId, dataList, labelList):
	...
	return [dataList[i] for i in np.where(labelList == 0)[0]]
...
#plt.scatter(getX(getData(0, learningData, learningLabel)), getY(getData(0, learningData, learningLabel)))
#plt.scatter(getX(getData(1, learningData, learningLabel)), getY(getData(1, learningData, learningLabel)))
#plt.scatter(getX(getData(0, testData, testLabel)), getY(getData(0, testData, testLabel)))
#plt.scatter(getX(getData(1, testData, testLabel)), getY(getData(1, testData, testLabel)))
#plt.show()
